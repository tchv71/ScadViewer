...
"$(INTDIR)\Mp4PlayerMFC.obj" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\ScadViewer.pch"


!ELSEIF  "$(CFG)" == "ScadViewer - Win32 Debug"


"$(INTDIR)\Mp4PlayerMFC.obj"	"$(INTDIR)\Mp4PlayerMFC.sbr" : $(SOURCE) "$(INTDIR)" "$(INTDIR)\ScadViewer.pch"

...
protected:
    BOOL GetCellRect(int nIndex, const LPRECT& rect) const;
	...
	static LPCTSTR GetColourName(int nIndex)
	{
		static CString strName;
		strName.LoadString(20000+nIndex);
		return strName;/*m_crColours[nIndex].szName;*/
	}

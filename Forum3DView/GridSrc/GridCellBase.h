...
public:
	...
	virtual const CGridCellBase* GetConstDefaultCell() const;
...
public:
	...
	virtual BOOL GetTextRect(LPRECT pRect) const; // i/o:  i=dims of cell rect; o=dims of text rect
	virtual BOOL GetTipTextRect(LPRECT pRect)
	{
		return GetTextRect(pRect);
	} // may override for btns, etc.
	virtual CSize GetTextExtent(LPCTSTR str, CDC* pDC = nullptr) const;

...
void AFXAPI DDX_ColorButton(CDataExchange *pDX, int nIDC, COLORREF& crColour)
{
    ...
    CColorButton* pColourButton = static_cast<CColorButton*>(CWnd::FromHandle(hWndCtrl));
...
{
	m_strDefaultText.LoadString(IDS_STRING_AUTOMATIC_COLOR);
	m_strCustomText.LoadString(IDS_STRING_CUSTOM_COLOR);
}

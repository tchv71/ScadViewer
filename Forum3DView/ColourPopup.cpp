...
CColourPopup::ColourTableEntry CColourPopup::m_crColours[] = 
{
    ...
    { RGB(0x00, 0x33, 0x33)}, //    _T("Dark Olive Green")  },
    ...
    { RGB(0x33, 0x33, 0x33)}, //    _T("Dark grey")         },
    ...
    { RGB(0x66, 0x66, 0x99)}, //    _T("Blue-grey")         },
    ...
    { RGB(0xCC, 0xFF, 0xCC)}, //    _T("Pale green ")       },
    { RGB(0xCC, 0xFF, 0xFF)}, //    _T("Pale turquoise")    },
...
void CColourPopup::Initialise()
{
    ...
    LOGPALETTE* pLogPalette = reinterpret_cast<LOGPALETTE*>(&pal);
                          ...
                          LPCTSTR szCustomText  /* = NULL */)
{
    ...
    if (!CWnd::CreateEx(0, szClassName, _T(""), WS_VISIBLE|WS_POPUP, 
                        ...
                        pParentWnd->GetSafeHwnd(), nullptr, nullptr))
        return FALSE;

    // Store the Custom text
    if (szCustomText != nullptr) 
        m_strCustomText = szCustomText;

    // Store the Default Area text
    if (szDefaultText != nullptr) 
...
BOOL CColourPopup::GetCellRect(int nIndex, const LPRECT& rect) const
{
...
void CColourPopup::SetWindowSize()
{
    ...
    {
        CClientDC dc(this);
        CFont* pOldFont = static_cast<CFont*>(dc.SelectObject(&m_Font));
...
void CColourPopup::DrawCell(CDC* pDC, int nIndex)
{
    ...
    if (m_strCustomText.GetLength() && nIndex == CUSTOM_BOX_VALUE)
    {
        ...
        // Draw custom text
        CFont *pOldFont = static_cast<CFont*>(pDC->SelectObject(&m_Font));
